            ...
            <section>
                <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                        ...
                        <div class="lg:py-24">
                            <h2 class="text-3xl font-bold sm:text-4xl font-inter">HALLO SELAMAT DATANG DIHALAMAN BUKU TAMU
                                SMK MADYA DEPOK</h2>

                            <p class="mt-4 text-gray-600">
                                Hai semoga hari mu menyenangkan silahkan untuk mengisi formulir terlebih dahulu klik button
                                dibawah ini
                            </p>
                    ...
                    <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                        ...
                        <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                            <form>
                                @csrf
                                <div>
                                    <label class="" for="Nama">NAMA ANDA :</label>
                                    <input
                                ...
                                <div>
                                    <label for="message">PENJELASAN : </label>
                                    <textarea class="w-full rounded-lg ring-2 ring-sky-800 focus:ring-2 focus:ring-blue-700 p-3 text-sm"
                                        placeholder="penjelasan" rows="8" id="message" name="penjelasan"></textarea>
                                    @error('penjelasan')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea class="w-full rounded-lg ring-2 ring-sky-800 focus:ring-2 focus:ring-blue-700 p-3 text-sm"
                                        placeholder="Saran dan kritik" rows="4" id="saran" name="saran"></textarea>
                                    @error('saran')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
